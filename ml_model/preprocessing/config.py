...
# ---------------------------------------------------------------------------
USDA_DIR = (RAW_DIR / "usda") if (RAW_DIR / "usda").exists() else (DATASETS_DIR / "usda")
...
# ---------------------------------------------------------------------------
MEALS_DIR = (RAW_DIR / "meals") if (RAW_DIR / "meals").exists() else (DATASETS_DIR / "meals")
...
# ---------------------------------------------------------------------------
DISEASE_DIR = (RAW_DIR / "disease") if (RAW_DIR / "disease").exists() else (DATASETS_DIR / "disease")
...
# ---------------------------------------------------------------------------
DIET_DIR = (RAW_DIR / "diet_recommendation") if (RAW_DIR / "diet_recommendation").exists() else (DATASETS_DIR / "diet_recommendation")
